...
n1_df.to_csv('./data/200_thml_n1_df.csv', index=False)
entr1_df.to_csv('./data/200_thml_entr1_df.csv', index=False)
np.savez('./data/200_thml_l1.npz', lasers=l1)
...
# n2_df.to_csv('./data/200_thml_n2_df.csv', index=False)
# entr2_df.to_csv('./data/200_thml_entr2_df.csv', index=False)
# np.savez('./data/200_thml_l2.npz', lasers=l2)
...
# n3_df.to_csv('./data/200_thml_n3_df.csv', index=False)
# entr3_df.to_csv('./data/200_thml_entr3_df.csv', index=False)
# np.savez('./data/200_thml_l3.npz', lasers=l3)

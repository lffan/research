...
n1_df.to_csv('./data/200_vacu_n1_df.csv', index=False)
entr1_df.to_csv('./data/200_vacu_entr1_df.csv', index=False)
np.savez('./data/200_vacu_l1.npz', lasers=l1)
...
n2_df.to_csv('./data/200_vacu_n2_df.csv', index=False)
entr2_df.to_csv('./data/200_vacu_entr2_df.csv', index=False)
np.savez('./data/200_vacu_l2.npz', lasers=l2)
...
n3_df.to_csv('./data/200_vacu_n3_df.csv', index=False)
entr3_df.to_csv('./data/200_vacu_entr3_df.csv', index=False)
np.savez('./data/200_vacu_l3.npz', lasers=l3)
